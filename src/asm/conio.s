...
; void wrcurchr (unsigned char);
; Write a character to the sreen at the current cursor position
...
; unsigned char rdcurchr (void);
; Read a character from the sreen at the current cursor position
...
; void txtinit (void);
; Initialises the text vdu

.globl _txtinit

_txtinit::
	call 	0xBB4E	; TXT INITIALISE
	ret
